...
- [TAPShield: Securing Trigger-Action Platforms against Strong Attackers](https://people.kth.se/~musard/research/pubs/eurosp25.pdf) Mojtaba Moazen, Nicolae Paladi, Adnan Jamil Ahsan, Musard Balliu. Proceedings of the IEEE European Symposium on Security and Privacy, (**EuroS&P'25**), 2025. 
- [Evaluating the maintainability of Forward-Porting vulnerabilities in fuzzer benchmarks](https://conf.researchr.org/details/icsme-2025/icsme-2025-papers/1/Evaluating-the-maintainability-of-Forward-Porting-vulnerabilities-in-fuzzer-benchmark) Timothée Riom, Sabine Houy, Bruno Kreyssig, Alexandre Bartel. The International Conference on Software Maintenance and Evolution (**ICSME'2025**), 2025.
...
- [Meta-Adaptation Goals: Leveraging Feedback Loop Requirements for Effective Self-Adaptation](https://ieeexplore.ieee.org/document/10766327) Raffaela Groner, Ricardo Diniz Caldas, Rebekka Wohlrab. In 2024 IEEE International Conference on Autonomic Computing and Self-Organizing Systems Companion (**ACSOS-C'24**), September 2024.
